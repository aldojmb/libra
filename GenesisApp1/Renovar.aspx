...
<script runat="server">
    string _UserApp;
    string _UserID;
    System.Data.DataTable dtRenovar = new System.Data.DataTable();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["NumPoliza"] != null)
        {
            if (!IsPostBack)
            {
                ...
                dtRenovar = new System.Data.DataTable();
                dtRenovar = AsignToTable(obten_Query("RenuevaPoliza", NumPoliza, "", "", "", ""));
                pnlBuscador.Visible = false;

                if (dtRenovar.Rows.Count >= 1)
                {
                    lblError.Text = dtRenovar.Rows[0][1].ToString();
                    cargaRepeater(txtBuscar.Text.ToString());
                }
                
                else
                {
                    lblError.Text = "Poliza Renovada";
                    cargaRepeater(txtBuscar.Text.ToString());
                }
            }
        }
    ...
    {
        dtRenovar = new System.Data.DataTable();
        dtRenovar = AsignToTable(obten_Query("BuscaRenovarPoliza", parametro, "", "", "", ""));
        pnlBuscador.Visible = false;

        if (dtRenovar.Rows.Count >= 1)
        {
            pnlBuscador.Visible = true;
            rptGridPoliza.DataSource = dtRenovar;
    ...
    public string obten_Query(String Concepto, String variable1, String variable2, String variable3, String variable4, String variable5)
    {
        switch (Concepto)
        {
            case "BuscaRenovarPoliza":
                return "exec pr_GEN_Poliza_Buscar @valor='" + variable1 + "', @type=0, @bStatus=3;";
                            ...
                            <table style="width:100%; height:30px;">
                                <tr>
                                    ...
                                    <td class="style58" style="background-color: #ee2c24; color: #FFFFFF; background-image: url('images/pattern_bg.gif'); text-align: center;">
                                        <asp:Image ID="imgEye" runat="server" ImageUrl="images/clo_2.png" />
                                    </td>
                                    <td></td>
                                </tr>
                            </table>
                                    ...
                                    <asp:Repeater ID="rptGridPoliza" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="style58" style="background-color:#ffffff; text-align: center;"><a href="Renovar.aspx?NumPoliza=<%# DataBinder.Eval(Container.DataItem, "iPolizaID")%>" ><asp:Image ID="imgView_1" runat="server"  ImageUrl="images/clo_1.png" /></a></td>
                                                <td></td>
                                            </tr>
                                        </ItemTemplate>
                                        <AlternatingItemTemplate>
                                            <tr>
                                                ...
                                                <td class="style58" style="background-color:#fafafa; text-align: center;"><a href="Renovar.aspx?NumPoliza=<%# DataBinder.Eval(Container.DataItem, "iPolizaID")%>" ><asp:Image ID="imgView_2" runat="server"  ImageUrl="images/clo_1.png" /></a></td>
                                                <td></td>
                                            </tr>
                                        </AlternatingItemTemplate>
                                    </asp:Repeater>
