    ...
    public sealed class Elementos
    {
        public string obten_Query(String Concepto, String variable1, String variable2, String variable3, String variable4, String variable5)
        {
            switch (Concepto)
            {
                ...
                case "BuscaPoliza":
                    return "exec pr_GEN_Poliza_Buscar @valor='" + variable1 + "', @type=0, @bStatus=1;";

                case "BuscaRenovarPoliza":
                    return "exec pr_GEN_Poliza_Buscar @valor='" + variable1 + "', @type=0, @bStatus=3;";

                case "PolizaActualizada":
                    return "exec pr_GEN_Poliza_Buscar @valor='" + variable1 + "', @type=0, @bStatus=6;";

                case "PolizaRenovada":
                    return "exec pr_GEN_Poliza_Buscar @valor='" + variable1 + "', @type=0, @bStatus=7;";
